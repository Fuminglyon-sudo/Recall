  ...
  await prisma.card.createMany({
    data: [
      ...
      },
      {
        ...
        partOfSpeech: "verb",
        example: "We incorporated founder-focused vocabulary into Recall so the learning loop improves real communication.",
      ...
      },
      {
        ...
        partOfSpeech: "noun",
        example: "Clear positioning helps people understand Recall before I start talking about features.",
      ...
      {
        deckId: founderDeck.id,
        front: "incorporate that context into Recall",
        back: "A more product-minded and professional alternative to saying add it to Recall.",
        partOfSpeech: "rewrite pattern",
        example: "Please review both projects and incorporate that context into Recall.",
        ...
        kind: "FOUNDER",
        sourceContext: "Rewrite upgrade from a request to review sibling apps and use them inside Recall.",
        dueAt: today,
      },
      {
        deckId: founderDeck.id,
