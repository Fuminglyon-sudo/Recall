  ...
  const words = [
    {
      ...
      partOfSpeech: "noun",
      example: "Recall's flywheel: users review cards → retention improves → they tell other founders → more cards get added → the product deepens.",
    ...
    },
    {
      ...
      partOfSpeech: "noun",
      example: "For Recall, activation is the moment a user reviews their first card and realises the spaced repetition is already working.",
