        ...
        <div className="space-y-6 border-t border-white/8 px-6 py-6">
          <div>
            ...
            <p className="text-sm leading-7 text-slate-300">
              ...
              well come back less often; cards you struggle with return sooner. Grade yourself
              honestly and the algorithm does the rest. Over time, mastered cards fade into the
              background and only resurface when you need a light refresh.
            </p>
          </div>
