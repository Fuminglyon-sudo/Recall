...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: "Daily cards surface words right before you forget them. AI scenarios let you rehearse the room before you enter it. Every session compounds into someone who knows what to say — and when.",
    caption: null,
    loop: ["Word", "Scenario", "Conversation"],
    features: null,
  },
  {
    id: "features",
  ...
  },
  {
    ...
    body: "Train recall, speaking, and social confidence in one daily loop. Start free in under a minute.",
    caption: null,
    loop: null,
    features: null,
  },
...
const PROOF_CHIPS = ["Free forever", "No card required", "Built for speaking + memory"];
